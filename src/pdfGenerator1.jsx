  ...
  const generatePdf = () => {
    ...
    pdf.autoTable({
      ...
      didDrawPage: function (data) {
        //Add grand total in the end of the table
        const lastRowY = data.cursor.y;
        pdf.setFontSize(12)
        pdf.setFont('helvetica', 'bold');
        pdf.text(`Grand Total: ${grandTotal.toLocaleString()}`, 13, lastRowY + 10);
      },
    });
          ...
          {itemsData.map((item, index) => (
            ...
            <tfoot>
                <tr>
                    ...
                    <td colSpan="2" style={{ fontWeight: 'bold' }}>{grandTotal.toLocaleString()}</td>
                </tr>
            </tfoot>
      </table>
